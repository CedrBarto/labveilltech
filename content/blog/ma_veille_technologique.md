...
draft: false
image: "/images/Articles/Image_Article2.png"
tags: ["Veille technologique", "Technologie", "UX", "UI"]
categories: ["général"]
weight: 2
---
...
### Comment je pourrais améliorer ma veille

Au lieu d'aller chercher l'info, je pourrais la faire venir à moi. Je prévois de m'abonner à des références comme UX Collective ou Sidebar.io qui me permettrait de recevoir une sélection triée une fois par semaine directement dans ma boîte mail où je pourrais y créer une catégorie dédiée.

J'aimerais tester des outils comme Feedly. Cela me donnerais la possibilité de regrouper en un seul endroit des articles ou les dernières tendances design, sans avoir à ouvrir pleins onglets Google. Je pourrais utiliser la plateforme Mobbin, j’ai découvert que c’était un vrai moyen de voir comment les grandes apps (Airbnb, Uber, etc.) gèrent leurs parcours utilisateurs.

### Conclusion

La veille, c'est comme le design ca se travaille. Mon système actuel sur les réseaux sociaux reste un bon début mais pour atteindre un réel objectif pertinent pour mon domaine, je dois devenir plus sélectif et curieux de ce qui se passe et se fait autour de mon domaine.